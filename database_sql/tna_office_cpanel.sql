-- =====================================================
-- TNA OFFICE - Base de Datos Completa para cPanel MySQL/MariaDB
...
('4885b67b-a21c-46b9-8bbc-49f1b62d2460', 'Recepcionista', 'Acceso a módulos de atención al cliente', '["dashboard", "resources", "requests", "tickets", "clients"]', 0, NOW());
...
('3f5e3023-c00e-48ab-8e68-9bdf9e58c70b', 'Diseño WEB', 'Servicios de diseño web', NOW()),
('2d0ec858-d751-4fb5-90db-e20be32c9bb4', 'Elementos Corporativos', 'Artículos corporativos', NOW()),
('6d2e7cea-32d1-4452-93ed-34514e459de1', 'Impresiones Corporativas', 'Servicios de impresión', NOW()),
...
INSERT INTO `products` (`id`, `name`, `description`, `category_id`, `base_price`, `cost`, `unit`, `is_active`, `created_at`) VALUES
('prod-1', 'Diseño Logo', 'Diseño de logotipo profesional', '3f5e3023-c00e-48ab-8e68-9bdf9e58c70b', 150000.00, 50000.00, 'unidad', 1, NOW()),
('prod-2', 'Tarjetas de Presentación', 'Pack 100 unidades', '6d2e7cea-32d1-4452-93ed-34514e459de1', 25000.00, 10000.00, 'pack', 1, NOW()),
('prod-3', 'Lavado Básico', 'Lavado exterior básico', 'c81fcafc-4c94-4a89-b242-c57d53ea1362', 8000.00, 3000.00, 'servicio', 1, NOW());
...
('155c37b8-1cdc-448e-84f5-6139eb7621db', 'PEOPLE IN MIND', '76.123.456-7', 'Servicios', 'Av. Las Condes 123', '+56912345678', 'contacto@peopleinmind.cl', 'Juan Pérez', '+56912345678', 'juan@peopleinmind.cl', 'Cliente corporativo', 1, NOW()),
('a1d19c32-9cf2-4769-a172-fc797cb88457', 'FUNDACION BEETHOVEN', '65.234.567-8', 'Fundación', 'Providencia 456', '+56923456789', 'info@beethoven.cl', 'María González', '+56923456789', 'maria@beethoven.cl', 'Cliente corporativo', 1, NOW()),
('e446660a-3590-4128-bfbb-c4077482b76b', 'SOUTH GREEN', '77.345.678-9', 'Comercio', 'Vitacura 789', '+56934567890', 'ventas@southgreen.cl', 'Carlos López', '+56934567890', 'carlos@southgreen.cl', 'Cliente activo', 1, NOW());
...
-- ═══════════════════════════════════════════════════════════════
-- TABLA: monthly_services_catalog (Catálogo de servicios mensuales)
-- ═══════════════════════════════════════════════════════════════
...
INSERT INTO `monthly_services_catalog` (`id`, `name`, `description`, `monthly_price`, `category`, `is_active`, `created_at`) VALUES
('service-1', 'Servicio de Internet', 'Internet fibra óptica 100 Mbps', 45000.00, 'conectividad', 1, NOW()),
('service-2', 'Limpieza de Oficina', 'Servicio de limpieza diaria', 80000.00, 'mantenimiento', 1, NOW()),
('service-3', 'Servicio Secretarial', 'Recepción de llamadas y mensajes', 35000.00, 'administrativo', 1, NOW());
...
-- ═══════════════════════════════════════════════════════════════
-- TABLA: quote_templates (Plantillas de cotización)
-- ═══════════════════════════════════════════════════════════════
